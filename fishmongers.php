            ...
            <div class="main-wrapper">
                <div class="home-row-wrapper">
                    <div class="home-row-title-wrapper">
                        <div class="home-row-title">Our Patner Trader ---- FISHMONGERS ----</div>
                    </div>
                    <div class="home-row-content">
                        <div class="shop-by-images-wrapper shop-img-side-marg-fishmongers">
                ...
                <div class="home-row-wrapper">
                    <div class="home-row-title-wrapper">
                        <div class="home-row-title">High Quality Products From Fishmongers</div>
                    </div>
                    <div class="home-row-content">
                        <div class="card-row">
                            <div class="card-col">
